...
function FokontanyViews() {
  ...
  const confirmDelete = () => {
    console.log("Deleted:", ResponsableToDelete)
    setOpenDialog(false)
    setOpenSnackbar(true)
  }
  ...
  return (
    <>
      ...
      {/* Modal de création */}
      <ResponsableCreate isOpen={openCreateModal} onSave={handleSaveCreate} onClose={() => setOpenCreateModal(false)} />

      {/* Modal d'édition */}
      <ResponsableEdit
        isOpen={openEditModal}
        fokontany={selectedResponsable}
        onChange={(updatedFokontany) => setSelectedResponsable(updatedFokontany)}
