...
const acteurSchema = z.object({
    ...
    role_acteurs: z.string().min(1, "Le rôle est requis"),
    ...
    interventions_actuelles: z.string().optional(),
    domaines_intervention_possibles: z.string().optional(),
    ouverture: z.string().min(1, "L'ouverture est requise")
});
